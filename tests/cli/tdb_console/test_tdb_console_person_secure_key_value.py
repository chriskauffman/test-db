...
def test_person_secure_key_value_delete(capsys, monkeypatch, temporary_db, person):
    person_key_value = test_db.PersonSecureKeyValue(
        ...
        person=person,
        key="test_person_secure_key_value_delete",
        value="test_person_secure_key_value_delete_value",
    )
    assert (
    ...
    monkeypatch.setattr(
        ...
        [
            "tdb",
            f"tdb_person_secure_key_value_delete {person.gID} {person_key_value.key}",
            "quit",
        ],
    )
...
def test_person_secure_key_value_list(capsys, monkeypatch, temporary_db):
    ...
    person_key_value = test_db.PersonSecureKeyValue(
        connection=temporary_db.connection,
        person=person,
        key="test_person_secure_key_value_list",
        value="test_person_secure_key_value_list_value",
    )
    monkeypatch.setattr(
        "sys.argv",
        [
...
def test_person_secure_key_value_view(capsys, monkeypatch, temporary_db):
    ...
    personal_key_value = test_db.PersonSecureKeyValue(
        connection=temporary_db.connection,
        person=person,
        key="test_person_secure_key_value_view",
        value="test_person_secure_key_value_view_value",
    )
    monkeypatch.setattr(
        "sys.argv",
        [
            "tdb",
            f"tdb_person_secure_key_value_view {person.gID} {personal_key_value.key}",
            "quit",
        ],
    )
