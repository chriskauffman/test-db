...
def test_person_key_value_delete(capsys, monkeypatch, temporary_db, person):
    person_key_value = test_db.PersonKeyValue(
        ...
        person=person,
        itemKey="test_person_key_value_delete",
        itemValue="test_person_key_value_delete_value",
    )
    assert (
    ...
    monkeypatch.setattr(
        ...
        [
            "tdb",
            f"tdb_person_key_value_delete {person.gID} {person_key_value.itemKey}",
            "quit",
        ],
    )
...
def test_person_key_value_list(capsys, monkeypatch, temporary_db):
    ...
    person_key_value = test_db.PersonKeyValue(
        connection=temporary_db.connection,
        person=person,
        itemKey="test_person_key_value_list",
        itemValue="test_person_key_value_list_value",
    )
    monkeypatch.setattr(
        "sys.argv",
        [
