...
If this is set with a valid SQLObject connection URI such as `export PYTEST_DATABASE_CONNECTION_URI=postgres://test_db:BADPASSWORD@nas02/test_db` or `export PYTEST_DATABASE_CONNECTION_URI=mysql://test_db:BADPASSWORD@nas02/test_db`
