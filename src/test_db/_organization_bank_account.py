...
class OrganizationBankAccount(SQLObject):
    ...
    Attributes:
        ...
        organizationRoutingNumberAccountNumberIndex (DatabaseIndex):
    """
    ...
    organizationRoutingNumberAccountNumberIndex: DatabaseIndex = DatabaseIndex(
        organization, routingNumber, accountNumber, unique=True
    )
